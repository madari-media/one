...
export const PlaybackOptionsPanel: React.FC<PlaybackOptionsPanelProps> = ({
  playbackOptions,
  isOpen,
  onOpenChange,
  ...
  return (
    <Popover open={isOpen} onOpenChange={onOpenChange}>
      ...
      <PopoverContent 
        className="w-80 bg-zinc-800 border border-zinc-700 text-white p-0"
        side="top"
        align="end"
        sideOffset={8}
        onInteractOutside={(e) => {
          // Check if the click is on a select dropdown or other form element
      ...
      >
        <div className="p-4 space-y-4">
          <div className="flex items-center justify-between border-b border-zinc-700 pb-2">
            <div className="flex items-center gap-2">
              <Settings className="w-4 h-4" />
              <span className="font-semibold">Playback Options</span>
            </div>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <select
              ...
              className="w-full bg-zinc-700 border border-zinc-600 rounded-md px-3 py-2 text-sm text-white appearance-none cursor-pointer hover:bg-zinc-600 transition-colors"
            >
              {availableBitrates
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1 min-w-16">
              <input
                ...
                className="w-12 bg-zinc-700 border border-zinc-600 rounded px-1 py-1 text-xs text-center"
              />
        ...
        <div className="pt-2 border-t border-zinc-700">
          <button
            ...
            className="w-full px-3 py-2 text-sm bg-zinc-700 hover:bg-zinc-600 text-zinc-300 rounded-md transition-colors"
          >
            Reset to Defaults
          </button>
        </div>
