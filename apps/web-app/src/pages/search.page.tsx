        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <Input
              ...
              className={cn(
                'pl-10 pr-10 bg-zinc-800/50 border-zinc-700 text-zinc-300 placeholder:text-zinc-500 rounded-xl focus:border-orange-500 focus:ring-orange-500/20 w-full transition-all duration-300',
