...
export const CatalogRenderer: React.FC = () => {
  ...
  const [cardSize, setCardSize] = React.useState(200);
  ...
  // Filter catalogs based on selected content type
  const filteredCatalogs = React.useMemo(() => {
    if (!catalogs) return [];
    if (selectedContentType === null) return catalogs;
  ...
  return (
    <div className="min-h-screen bg-zinc-900">
      <div className="space-y-12 p-2 md:p-4 pt-4">
